...
function Contacto() {
    ...
    return (
        <div className={`grid h-[100vh] ${isAuthenticated ? 'grid-cols-3' : 'grid-cols-1'}`} style={{ gridTemplateRows: '80px auto 60px', gridTemplateColumns: isAuthenticated ? '240px 1fr' : '1fr' }}>
            <header>
                <WelcomeBar />
            </header>
            ...
            <main className={`${isAuthenticated ? 'col-start-2' : 'col-start-1'} flex justify-center items-center relative`}>
                ...
                <div className="min-h-screen bg-gray-800 py-6 flex flex-col justify-center sm:py-8">
                    <div className="relative py-3 sm:max-w-xl sm:mx-auto">
                        <div className="absolute inset-0 bg-[#E6D88A] shadow-lg transform -skew-y-6 sm:skew-y-0 sm:-rotate-6 sm:rounded-3xl">
                        </div>
