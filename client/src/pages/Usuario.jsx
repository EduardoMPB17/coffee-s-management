                ...
                <div className="mx-auto mt-2 w-1/4 relative">
                    <div className="bg-white rounded-lg overflow-hidden">
                        <div className="text-center p-6 bg-[#4A3B25]">
                            ...
                            <p className="border rounded-full py-4 px-2 text-lg font-semibold text-gray-100">{user.email}</p>
                            <p className="border rounded-full py-4 px-2 text-lg font-semibold text-gray-100">{}</p>
                            <p className="border rounded-full py-4 px-2 text-lg font-semibold text-gray-100">{}</p>
                        </div>
                    </div>
                </div>
